...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse"  align = "center" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="others\login.php">Profile</a>
      </li>
      <li class="nav-item">
  ...
  <source src="video2.ogg" type="video/ogg"/>
     ...
     <br><br><br><br>
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link" href="register.php">Creat a new account</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="login.php">Drive Link</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-sm-8">
      <h2>Hack Link</h2>
      <h5>Update, Feb 15, 2020</h5>
      <br><br>
<div>
     <a href="https://bit.ly/2OXkhGS" align="center"><h3>For Emulator</h3>

<br><br>

       <a href="https://bit.ly/39vLrfI" align="center"><h3>For Mobile</h3>
      </div>
    </div>
  </div>
</div>
